    ...
    <section ref={heroRef} id="hero" className="relative scroll-mt-24 border-b border-border/80 py-12 sm:py-20 lg:py-28">
      ...
      >
        <div className="grid gap-10 lg:grid-cols-[1.25fr_0.75fr] lg:items-center lg:gap-16">
          ...
          >
            <motion.h1 className="max-w-3xl font-heading text-5xl font-semibold leading-[0.94] tracking-[-0.055em] text-foreground sm:text-7xl lg:text-[7.5rem]" variants={staggerItem}>
              {personalInfo.name}
            </motion.h1>
          ...
          <motion.div className="flex justify-center lg:justify-end" variants={staggerItem}>
            <motion.div
