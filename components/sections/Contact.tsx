    ...
    <section id="contact" ref={sectionRef} className="relative scroll-mt-24 py-20 sm:py-24 overflow-hidden">
      ...
      >
        ...
        <form className="mt-10 grid gap-6 lg:grid-cols-2" onSubmit={handleSubmit} noValidate>
          <motion.div style={{ x: shouldReduceMotion ? 0 : leftX, opacity: shouldReduceMotion ? 1 : opacity }} className="space-y-6">
            <div>
          ...
          <motion.div style={{ x: shouldReduceMotion ? 0 : rightX, opacity: shouldReduceMotion ? 1 : opacity }} className="flex flex-col">
